    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('job_seeker', 'Job Seeker'), ('employer', 'Employer'), ('admin_staff', 'Admin/Staff')], max_length=35)),
                ('image', models.ImageField(blank=True, default='defaultpp.jpg', null=True, upload_to=accounts.models.user_directory_path)),
